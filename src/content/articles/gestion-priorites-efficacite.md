...
description: "Description de l'article Gestion Priorites Efficacite"
...
```mermaid
graph TD
    A[Urgent et Important] --> B[Faire immédiatement]
    C[Important mais pas Urgent] --> D[Planifier]
    E[Urgent mais pas Important] --> F[Déléguer]
    G[Ni Urgent ni Important] --> H[Éliminer]
```
