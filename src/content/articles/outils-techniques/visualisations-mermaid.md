...
1. **[Mermaid : Guide Complet des Diagrammes Techniques 2025](outils-techniques/mermaid-example)** - Maîtrisez Mermaid pour créer des diagrammes professionnels. Guide expert avec exemples pratiques, syntaxe avancée et bonnes pratiques pour la documentation technique.

2. **[Guide Complet des Pills : Système de Classification Visuelle 2025](outils-techniques/pillcolor-guide)** - Maîtrisez l'art des pills colorées pour organiser et classifier vos contenus. Guide expert avec palette de couleurs, psychologie des couleurs et bonnes pratiques UX.
