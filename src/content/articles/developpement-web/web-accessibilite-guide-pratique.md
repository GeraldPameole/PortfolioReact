...
Depuis l'entrée en application de l'European Accessibility Act le 28 juin 2025, le contexte a aussi changé : l'accessibilité n'est plus un nice-to-have qu'on traitera "plus tard". Pour une bonne partie des sites e-commerce, bancaires ou de transport, c'est devenu une obligation légale assortie de sanctions. J'aborde ce point plus bas — mais l'angle pratique reste le même : les quatre corrections qui comptent vraiment n'ont pas bougé.
...
**Niveau AA** — le standard attendu. C'est ce que la plupart des réglementations européennes exigent, et c'est aussi la base de l'European Accessibility Act (voir plus bas). Il couvre les contrastes de couleur suffisants, les étiquettes de formulaire associées, les messages d'erreur compréhensibles. Si votre site ne vise rien d'autre, visez au moins AA — en pratique, c'est devenu le plancher légal sur la plupart des sites grand public.
...
**Les sanctions.** En France, le non-respect peut entraîner une amende administrative pouvant aller jusqu'à **250 000 € par produit ou service non conforme**, en plus d'une mise en demeure de mise en conformité. La logique est graduée — on ne tape pas le plafond pour un alt manquant — mais le risque est désormais chiffrable, ce qui change la façon dont les directions financières regardent le sujet.

**Quel référentiel appliquer.** Trois textes coexistent et se complètent au lieu de se contredire :

- **RGAA 4.1** côté français — le référentiel d'audit officiel, structuré en 106 critères opposables.
- **WCAG 2.2 niveau AA** côté contenu — la grille de critères techniques que le RGAA reprend.
- **EN 301 549** côté européen — la norme harmonisée d'évaluation, alignée sur WCAG 2.2 depuis mars 2024. C'est elle que cite la directive.

En pratique, viser WCAG 2.2 AA et auditer via le RGAA 4.1 vous met dans la zone de conformité de l'EAA. Inutile de réinventer une grille interne — utilisez ce qui existe.

<div style="overflow-x:auto;margin:2rem 0"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 360" style="max-width:100%;height:auto"><rect width="700" height="360" fill="#0a0f2e" rx="12"/><text x="350" y="28" font-family="monospace" font-size="13" fill="#00cffd" text-anchor="middle" font-weight="bold">EAA — PÉRIMÈTRE ET CONFORMITÉ</text><text x="350" y="46" font-family="monospace" font-size="9" fill="#7e8da4" text-anchor="middle">en application depuis le 28 juin 2025</text><rect x="30" y="70" width="200" height="270" rx="8" fill="#1a1f4e" stroke="#fb923c" stroke-width="1"/><text x="130" y="95" font-family="monospace" font-size="11" fill="#fb923c" text-anchor="middle" font-weight="bold">QUI EST CONCERNÉ</text><line x1="50" y1="105" x2="210" y2="105" stroke="#fb923c" stroke-width="0.5" opacity="0.4"/><text x="50" y="128" font-family="sans-serif" font-size="9" fill="#cbd5e1">• E-commerce B2C</text><text x="50" y="146" font-family="sans-serif" font-size="9" fill="#cbd5e1">• Banque consommateurs</text><text x="50" y="164" font-family="sans-serif" font-size="9" fill="#cbd5e1">• Transports (billets, info)</text><text x="50" y="182" font-family="sans-serif" font-size="9" fill="#cbd5e1">• Audiovisuel à la demande</text><text x="50" y="200" font-family="sans-serif" font-size="9" fill="#cbd5e1">• Livres numériques</text><text x="50" y="218" font-family="sans-serif" font-size="9" fill="#cbd5e1">• Communications électr.</text><rect x="45" y="240" width="170" height="80" rx="6" fill="#fb923c" fill-opacity="0.1" stroke="#fb923c" stroke-width="0.5" stroke-dasharray="3,2"/><text x="130" y="258" font-family="monospace" font-size="9" fill="#fdba74" text-anchor="middle" font-weight="bold">EXEMPTION MICROENTREPRISE</text><text x="130" y="278" font-family="sans-serif" font-size="9" fill="#cbd5e1" text-anchor="middle">&lt; 10 salariés</text><text x="130" y="293" font-family="sans-serif" font-size="9" fill="#cbd5e1" text-anchor="middle">ET</text><text x="130" y="308" font-family="sans-serif" font-size="9" fill="#cbd5e1" text-anchor="middle">CA &lt; 2 M€</text><rect x="250" y="70" width="200" height="270" rx="8" fill="#1a1f4e" stroke="#fbbf24" stroke-width="1"/><text x="350" y="95" font-family="monospace" font-size="11" fill="#fbbf24" text-anchor="middle" font-weight="bold">CALENDRIER &amp; SANCTIONS</text><line x1="270" y1="105" x2="430" y2="105" stroke="#fbbf24" stroke-width="0.5" opacity="0.4"/><circle cx="290" cy="135" r="6" fill="#fbbf24"/><text x="305" y="139" font-family="monospace" font-size="10" fill="#fbbf24" font-weight="bold">28 JUIN 2025</text><text x="305" y="155" font-family="sans-serif" font-size="9" fill="#cbd5e1">Entrée en application</text><circle cx="290" cy="180" r="6" fill="#fb923c"/><text x="305" y="184" font-family="monospace" font-size="10" fill="#fb923c" font-weight="bold">CONTRÔLES</text><text x="305" y="200" font-family="sans-serif" font-size="9" fill="#cbd5e1">Mise en demeure puis</text><text x="305" y="213" font-family="sans-serif" font-size="9" fill="#cbd5e1">obligation de mise en</text><text x="305" y="226" font-family="sans-serif" font-size="9" fill="#cbd5e1">conformité</text><rect x="265" y="245" width="170" height="80" rx="6" fill="#fb7185" fill-opacity="0.1" stroke="#fb7185" stroke-width="0.8"/><text x="350" y="265" font-family="monospace" font-size="9" fill="#fda4af" text-anchor="middle" font-weight="bold">SANCTION FRANCE</text><text x="350" y="290" font-family="monospace" font-size="15" fill="#fb7185" text-anchor="middle" font-weight="bold">250 000 €</text><text x="350" y="310" font-family="sans-serif" font-size="9" fill="#cbd5e1" text-anchor="middle">par service non conforme</text><rect x="470" y="70" width="200" height="270" rx="8" fill="#1a1f4e" stroke="#86efac" stroke-width="1"/><text x="570" y="95" font-family="monospace" font-size="11" fill="#86efac" text-anchor="middle" font-weight="bold">RÉFÉRENTIELS</text><line x1="490" y1="105" x2="650" y2="105" stroke="#86efac" stroke-width="0.5" opacity="0.4"/><rect x="485" y="125" width="170" height="55" rx="4" fill="#86efac" fill-opacity="0.08" stroke="#86efac" stroke-width="0.5"/><text x="570" y="143" font-family="monospace" font-size="10" fill="#86efac" text-anchor="middle" font-weight="bold">RGAA 4.1</text><text x="570" y="159" font-family="sans-serif" font-size="9" fill="#cbd5e1" text-anchor="middle">France · 106 critères</text><text x="570" y="173" font-family="sans-serif" font-size="9" fill="#cbd5e1" text-anchor="middle">opposables · audit officiel</text><rect x="485" y="190" width="170" height="55" rx="4" fill="#00cffd" fill-opacity="0.08" stroke="#00cffd" stroke-width="0.5"/><text x="570" y="208" font-family="monospace" font-size="10" fill="#00cffd" text-anchor="middle" font-weight="bold">WCAG 2.2 AA</text><text x="570" y="224" font-family="sans-serif" font-size="9" fill="#cbd5e1" text-anchor="middle">Contenu · grille technique</text><text x="570" y="238" font-family="sans-serif" font-size="9" fill="#cbd5e1" text-anchor="middle">reprise par le RGAA</text><rect x="485" y="255" width="170" height="55" rx="4" fill="#915EFF" fill-opacity="0.12" stroke="#915EFF" stroke-width="0.5"/><text x="570" y="273" font-family="monospace" font-size="10" fill="#b48bff" text-anchor="middle" font-weight="bold">EN 301 549</text><text x="570" y="289" font-family="sans-serif" font-size="9" fill="#cbd5e1" text-anchor="middle">Norme harmonisée UE</text><text x="570" y="303" font-family="sans-serif" font-size="9" fill="#cbd5e1" text-anchor="middle">alignée WCAG 2.2</text><text x="570" y="328" font-family="monospace" font-size="9" fill="#86efac" text-anchor="middle">→ viser WCAG 2.2 AA + RGAA 4.1</text></svg></div>

Ce qu'il faut retenir côté terrain : si vous démarrez un projet aujourd'hui dans l'un des secteurs concernés, l'accessibilité doit entrer dans la définition de "prêt à mettre en ligne", pas dans le backlog post-MVP. Rétrofitter coûte trois à cinq fois plus cher que produire conforme, c'est désormais documenté sur tous les audits que j'ai vus passer.
...
L'accessibilité n'est pas un projet à part entière — c'est une série de décisions de conception et de développement, prises au bon moment. Le bon moment, c'est pendant qu'on construit, pas après. Et depuis l'entrée en application de l'EAA en juin 2025, ce n'est plus seulement une question d'éthique professionnelle ou de qualité produit : c'est aussi une question de conformité réglementaire, avec un risque financier réel pour les secteurs concernés. Le bon réflexe n'a pas changé pour autant — il s'est juste élargi à davantage d'équipes.

> **Ce que ça veut dire concrètement** — WCAG 2.2 (juin 2023) est la version courante : neuf nouveaux critères sur le tactile et le cognitif s'ajoutent à WCAG 2.1. Les trois niveaux restent A (minimum absolu), AA (standard réglementaire, plancher de l'EAA), AAA (optimal rarement atteint globalement). Depuis le 28 juin 2025, l'European Accessibility Act rend WCAG 2.2 AA opposable pour l'e-commerce B2C, la banque, les transports et l'audiovisuel — sauf microentreprises (< 10 salariés ET CA < 2 M€) — avec des amendes jusqu'à 250 000 € par service non conforme en France. Les quatre corrections à fort impact n'ont pas bougé : contraste suffisant, focus clavier visible, alt pertinents, labels de formulaire associés. Un premier audit réaliste se fait sans outil : test clavier, zoom à 200%, et lecteur d'écran natif.
