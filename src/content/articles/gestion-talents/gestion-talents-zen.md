...
Chez KEOS TELECOM, où je pilote depuis 2021 la maintenance FTTB avec 17 mainteneurs sous-traitants distribués sur plusieurs sites, j'ai observé concrètement à quel point la QVT dépend des choix d'organisation. Pendant un pic d'incidents, la différence entre une équipe qui tient et une équipe qui craque ne se joue pas sur des séances de yoga — elle se joue sur la lisibilité des plannings, la rotation équitable des astreintes, et la capacité du manager à dire "on arrête, on ne prend plus de tickets ce soir, on reprend demain". Les semaines où j'ai laissé filer sur ces sujets, le MTTR remontait et l'absentéisme suivait dans les deux semaines. Les semaines où je tenais la barre, on restait sous nos 98,7 % de disponibilité réseau sans cramer personne. Le bien-être n'est pas un programme à côté du travail — c'est une dimension du pilotage.
