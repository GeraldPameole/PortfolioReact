...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 360" style="max-width:100%;height:auto">
  ...
  <text x="350" y="28" font-family="monospace" font-size="13" fill="#00cffd" text-anchor="middle" font-weight="bold">KAIZEN vs BIG BANG — DEUX TRAJECTOIRES SUR 18 MOIS</text>
  <text x="350" y="46" font-family="monospace" font-size="9" fill="#7e8da4" text-anchor="middle">la courbe lente gagne sur la durée parce qu'elle ne s'effondre pas</text>
  <!-- Repères axes -->
  <line x1="80" y1="280" x2="650" y2="280" stroke="#7e8da4" stroke-width="1"/>
  <line x1="80" y1="80" x2="80" y2="280" stroke="#7e8da4" stroke-width="1"/>
  <!-- Labels axes -->
  <text x="75" y="90" font-family="monospace" font-size="9" fill="#cbd5e1" text-anchor="end" font-weight="bold">Gains</text>
  <text x="75" y="100" font-family="monospace" font-size="8" fill="#7e8da4" text-anchor="end">cumulés</text>
  <text x="80" y="300" font-family="monospace" font-size="8" fill="#7e8da4" text-anchor="middle">M0</text>
  <text x="223" y="300" font-family="monospace" font-size="8" fill="#7e8da4" text-anchor="middle">M+3</text>
  <text x="365" y="300" font-family="monospace" font-size="8" fill="#7e8da4" text-anchor="middle">M+6</text>
  <text x="508" y="300" font-family="monospace" font-size="8" fill="#7e8da4" text-anchor="middle">M+12</text>
  <text x="650" y="300" font-family="monospace" font-size="8" fill="#7e8da4" text-anchor="middle">M+18</text>
  <!-- Repères horizontaux pointillés -->
  <line x1="80" y1="220" x2="650" y2="220" stroke="#1e2a5e" stroke-width="0.5" stroke-dasharray="3,3"/>
  <line x1="80" y1="160" x2="650" y2="160" stroke="#1e2a5e" stroke-width="0.5" stroke-dasharray="3,3"/>
  <line x1="80" y1="100" x2="650" y2="100" stroke="#1e2a5e" stroke-width="0.5" stroke-dasharray="3,3"/>
  <!-- Courbe Big Bang (rouge) -->
  <path d="M 80 280 L 200 270 L 260 250 L 320 110 L 400 130 L 480 200 L 560 240 L 650 260" fill="none" stroke="#ef4444" stroke-width="2.5" stroke-linecap="round"/>
  <!-- Pic Big Bang -->
  <circle cx="320" cy="110" r="4" fill="#ef4444"/>
  <text x="320" y="98" font-family="monospace" font-size="8" fill="#fca5a5" text-anchor="middle">pic au lancement</text>
  <text x="475" y="225" font-family="monospace" font-size="8" fill="#fca5a5" text-anchor="middle">retombée — retour habitudes</text>
  <!-- Courbe Kaizen (verte) — montée progressive et régulière -->
  <path d="M 80 280 L 145 268 L 210 252 L 280 232 L 350 210 L 420 184 L 490 158 L 560 130 L 650 100" fill="none" stroke="#86efac" stroke-width="2.5" stroke-linecap="round"/>
  <!-- Petits points Kaizen -->
  <circle cx="145" cy="268" r="2.5" fill="#86efac"/>
  <circle cx="210" cy="252" r="2.5" fill="#86efac"/>
  <circle cx="280" cy="232" r="2.5" fill="#86efac"/>
  <circle cx="350" cy="210" r="2.5" fill="#86efac"/>
  <circle cx="420" cy="184" r="2.5" fill="#86efac"/>
  <circle cx="490" cy="158" r="2.5" fill="#86efac"/>
  <circle cx="560" cy="130" r="2.5" fill="#86efac"/>
  <circle cx="650" cy="100" r="3.5" fill="#86efac"/>
  <!-- Légende encart Big Bang -->
  <rect x="100" y="90" width="180" height="50" rx="6" fill="#1a1f4e" stroke="#ef4444" stroke-width="1"/>
  <rect x="110" y="105" width="12" height="3" fill="#ef4444"/>
  <text x="130" y="110" font-family="monospace" font-size="10" fill="#fb7185" font-weight="bold">BIG BANG</text>
  <text x="110" y="125" font-family="sans-serif" font-size="8" fill="#fca5a5">Pic spectaculaire,</text>
  <text x="110" y="136" font-family="sans-serif" font-size="8" fill="#fca5a5">puis effondrement à M+9</text>
  <!-- Légende encart Kaizen -->
  <rect x="440" y="220" width="200" height="50" rx="6" fill="#1a1f4e" stroke="#86efac" stroke-width="1"/>
  <rect x="450" y="235" width="12" height="3" fill="#86efac"/>
  <text x="470" y="240" font-family="monospace" font-size="10" fill="#86efac" font-weight="bold">KAIZEN</text>
  <text x="450" y="254" font-family="sans-serif" font-size="8" fill="#a7f3d0">Petits gains chaque semaine,</text>
  <text x="450" y="265" font-family="sans-serif" font-size="8" fill="#a7f3d0">cumulés et standardisés</text>
  <text x="350" y="345" font-family="monospace" font-size="10" fill="#00cffd" text-anchor="middle" font-weight="bold">le grand projet impressionne, la discipline régulière transforme</text>
</svg>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 360" style="max-width:100%;height:auto">
  <rect width="700" height="360" fill="#0a0f2e" rx="12"/>
  <text x="350" y="28" font-family="monospace" font-size="13" fill="#00cffd" text-anchor="middle" font-weight="bold">ANATOMIE D'UN BON INDICATEUR KAIZEN</text>
  <text x="350" y="46" font-family="monospace" font-size="9" fill="#7e8da4" text-anchor="middle">si l'un des cinq critères manque, l'indicateur meurt en 3 mois</text>
  <!-- Indicateur central — carte focale -->
  <rect x="245" y="135" width="210" height="100" rx="10" fill="#1a1f4e" stroke="#915EFF" stroke-width="2"/>
  <text x="350" y="160" font-family="monospace" font-size="10" fill="#b48bff" text-anchor="middle" font-weight="bold">EXEMPLE — KEOS TELECOM</text>
  <line x1="265" y1="170" x2="435" y2="170" stroke="#915EFF" stroke-width="0.5" opacity="0.5"/>
  <text x="350" y="188" font-family="monospace" font-size="9" fill="#cbd5e1" text-anchor="middle">"Nombre de demandes</text>
  <text x="350" y="202" font-family="monospace" font-size="9" fill="#cbd5e1" text-anchor="middle">en attente &gt; 48 h"</text>
  <text x="350" y="222" font-family="monospace" font-size="16" fill="#b48bff" text-anchor="middle" font-weight="bold">7 → 2</text>
  <!-- Critère 1 — Concret -->
  <rect x="40" y="80" width="160" height="60" rx="8" fill="#1a1f4e" stroke="#86efac" stroke-width="1.2"/>
  <text x="50" y="100" font-family="monospace" font-size="10" fill="#86efac" font-weight="bold">CONCRET</text>
  <text x="50" y="118" font-family="sans-serif" font-size="9" fill="#a7f3d0">Mesure un irritant</text>
  <text x="50" y="131" font-family="sans-serif" font-size="9" fill="#a7f3d0">réel, pas un ratio</text>
  <!-- Ligne de connexion 1 -->
  <line x1="200" y1="125" x2="245" y2="155" stroke="#86efac" stroke-width="1" stroke-dasharray="3,3" opacity="0.6"/>
  <!-- Critère 2 — Choisi par l'équipe -->
  <rect x="500" y="80" width="160" height="60" rx="8" fill="#1a1f4e" stroke="#00cffd" stroke-width="1.2"/>
  <text x="510" y="100" font-family="monospace" font-size="10" fill="#67e8f9" font-weight="bold">CHOISI PAR L'ÉQUIPE</text>
  <text x="510" y="118" font-family="sans-serif" font-size="9" fill="#67e8f9">Pas imposé d'en haut.</text>
  <text x="510" y="131" font-family="sans-serif" font-size="9" fill="#67e8f9">Sens pour ceux qui font.</text>
  <!-- Ligne de connexion 2 -->
  <line x1="500" y1="125" x2="455" y2="155" stroke="#00cffd" stroke-width="1" stroke-dasharray="3,3" opacity="0.6"/>
  <!-- Critère 3 — Visuel -->
  <rect x="40" y="230" width="160" height="60" rx="8" fill="#1a1f4e" stroke="#fbbf24" stroke-width="1.2"/>
  <text x="50" y="250" font-family="monospace" font-size="10" fill="#fbbf24" font-weight="bold">VISUEL ET AFFICHÉ</text>
  <text x="50" y="268" font-family="sans-serif" font-size="9" fill="#fde68a">Là où les gens</text>
  <text x="50" y="281" font-family="sans-serif" font-size="9" fill="#fde68a">travaillent, pas dans Excel.</text>
  <!-- Ligne de connexion 3 -->
  <line x1="200" y1="245" x2="245" y2="215" stroke="#fbbf24" stroke-width="1" stroke-dasharray="3,3" opacity="0.6"/>
  <!-- Critère 4 — Revu hebdo -->
  <rect x="500" y="230" width="160" height="60" rx="8" fill="#1a1f4e" stroke="#fb923c" stroke-width="1.2"/>
  <text x="510" y="250" font-family="monospace" font-size="10" fill="#fdba74" font-weight="bold">REVU CHAQUE SEMAINE</text>
  <text x="510" y="268" font-family="sans-serif" font-size="9" fill="#fed7aa">Standup 15 min,</text>
  <text x="510" y="281" font-family="sans-serif" font-size="9" fill="#fed7aa">pas de PowerPoint.</text>
  <!-- Ligne de connexion 4 -->
  <line x1="500" y1="245" x2="455" y2="215" stroke="#fb923c" stroke-width="1" stroke-dasharray="3,3" opacity="0.6"/>
  <!-- Critère 5 en bas central — Limité à 3-5 -->
  <rect x="245" y="285" width="210" height="40" rx="8" fill="#1a1f4e" stroke="#ef4444" stroke-width="1.2"/>
  <text x="350" y="303" font-family="monospace" font-size="10" fill="#fb7185" text-anchor="middle" font-weight="bold">MAX 3 À 5 INDICATEURS</text>
  <text x="350" y="318" font-family="sans-serif" font-size="9" fill="#fca5a5" text-anchor="middle">au-delà personne ne suit, le tableau de bord meurt</text>
  <!-- Ligne de connexion 5 -->
  <line x1="350" y1="285" x2="350" y2="235" stroke="#ef4444" stroke-width="1" stroke-dasharray="3,3" opacity="0.6"/>
  <text x="350" y="352" font-family="monospace" font-size="10" fill="#00cffd" text-anchor="middle" font-weight="bold">un indicateur qui colle au quotidien se suit naturellement</text>
</svg>
</div>
